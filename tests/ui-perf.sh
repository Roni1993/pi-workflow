...
OUT=/tmp/ui-perf.mjs
npx --yes esbuild@0.23.1 tests/ui-perf.ts --bundle --format=esm --platform=node --alias:@earendil-works/pi-tui=./tests/pi-tui-stub.mjs --external:@earendil-works/pi-coding-agent --outfile="$OUT" --log-level=warning
